...
#pieceMeta = PieceData[len(PieceData) - 1]
...
"""
def get_color(tokenID):
    
    rarity = get_rarity(pieceMeta.tokenIdToRarity)
    pieceColor = "None"
    if rarity == "Common":
        switch = {0: "White", 1: "Steel", 2: "Stone"}
        return switch[pieceMeta.tokenIdToCommon(tokenID)]
    elif rarity == "Uncommon":
        switch = {0: "Green", 1: "Cadmium Green", 2: "Lawn Green", 3: "Mint Green"}
        return switch[pieceMeta.tokenIdToUncommon(tokenID)]
    elif rarity == "Rare":
        switch = {0: "Blue", 1: "Teal", 2: "Turqoise", 3: "Baby Blue"}
        return switch[pieceMeta.tokenIdToRare(tokenID)]
    elif rarity == "Epic":
        switch = {0: "Purple", 1: "Heliotrope", 2: "Indigo", 3: "Magenta"}
        return switch[pieceMeta.tokenIdToEpic(tokenID)]
