...
const Login = ({ onLogin }) => {
  ...
  const [selectedRedirect, setSelectedRedirect] = useState("/rewards");
  ...
  function handleRedirectChange(event) {
    setSelectedRedirect(event.target.value);
  }
        ...
        <div id="login">
          <form className="form" onSubmit={handleSubmit}>
            ...
            <div className="assists">
              ...
              <div className="assists forgot">Forgot Password</div>
            </div>
          </form>
        </div>
      </div>
